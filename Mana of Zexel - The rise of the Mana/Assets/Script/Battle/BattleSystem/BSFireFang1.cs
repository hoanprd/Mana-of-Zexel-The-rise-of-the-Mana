...
public class BSFireFang1 : MonoBehaviour
{
    PlayerBattle pb;
    FireFangBattle FFB;
    ...
    void Update()
    {
        ...
        else if (aE6 > 0 && Global.HPE6 > 0 && GameOver == false && zoomDone == true)
        {
            CheckE6Die();
            ShowP1Panel(false);
            ShowP2Panel(false);
    ...
    public void CheckE6Die()
    {
        if (Global.HPE6 <= 0)
        {
            ...
            if (stop == 0)
            {
                ...
                GoldenFeatherItem.text = "Golden feather +1";
            }
    ...
    void delayP1PressSkill()
    {
        ...
        else if (ChooseSkillIndex == 2)
        {
            ...
            Global.CurMPP1 -= 50;
            Global.HPE6 = Global.HPE6 - (Global.DamageP1 + (Global.DamageP1 * 200 / 100));
            PDamage.text = "";
            a1 -= 1;
            show1 = 0;
            dem_turn += 1;
        ...
        else if (ChooseSkillIndex == 3)
        {
            ...
            Global.CurMPP1 -= 100;
            Global.HPE6 = Global.HPE6 - (Global.DamageP1 + (Global.DamageP1 * 300 / 100));
            PDamage.text = "";
            a1 -= 1;
            show1 = 0;
            dem_turn += 1;
    ...
    void delayP2PressSkill()
    {
        ...
        {
            Global.CurMPP2 -= 50;
            Global.HPE6 = Global.HPE6 - (Global.DamageP2 + (Global.DamageP2 * 200 / 100));
            PDamage.text = "";
            a2 -= 1;
            show2 = 0;
            dem_turn += 1;
        ...
        {
            Global.CurMPP2 -= 100;
            Global.HPE6 = Global.HPE6 - (Global.DamageP2 + (Global.DamageP2 * 300 / 100));
            PDamage.text = "";
            a2 -= 1;
            show2 = 0;
            dem_turn += 1;
    ...
    void delayP3PressSkill()
    {
        ...
        else if (ChooseSkillIndex == 3)
        {
            ...
            Global.CurMPP3 -= 120;
            Global.HPE6 = Global.HPE6 - (Global.DamageP3 + (Global.DamageP3 * 300 / 100));
            PDamage.text = "";
            a3 -= 1;
            show3 = 0;
            dem_turn += 1;
