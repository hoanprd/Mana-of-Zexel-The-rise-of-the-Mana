...
public class BSManaSlime1 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else if (aE5 > 0 && Global.HPE5 > 0 && GameOver == false && zoomDone == true)
        {
            CheckE5Die();
            ShowP1Panel(false);
            ShowP2Panel(false);
    ...
    void delayP1PressSkill()
    {
        ...
        else if (ChooseSkillIndex == 2)
        {
            ...
            Global.CurMPP1 -= 50;
            Global.HPE5 = Global.HPE5 - (Global.DamageP1 + (Global.DamageP1 * 200 / 100));
            PDamage.text = "";
            a1 -= 1;
            show1 = 0;
            dem_turn += 1;
        ...
        else if (ChooseSkillIndex == 3)
        {
            ...
            Global.CurMPP1 -= 100;
            Global.HPE5 = Global.HPE5 - (Global.DamageP1 + (Global.DamageP1 * 300 / 100));
            PDamage.text = "";
            a1 -= 1;
            show1 = 0;
            dem_turn += 1;
    ...
    void delayP2PressSkill()
    {
        ...
        {
            Global.CurMPP2 -= 50;
            Global.HPE5 = Global.HPE5 - (Global.DamageP2 + (Global.DamageP2 * 200 / 100));
            PDamage.text = "";
            a2 -= 1;
            show2 = 0;
            dem_turn += 1;
        ...
        {
            Global.CurMPP2 -= 100;
            Global.HPE5 = Global.HPE5 - (Global.DamageP2 + (Global.DamageP2 * 300 / 100));
            PDamage.text = "";
            a2 -= 1;
            show2 = 0;
            dem_turn += 1;
    ...
    void delayP3PressSkill()
    {
        ...
        else if (ChooseSkillIndex == 3)
        {
            ...
            Global.CurMPP3 -= 120;
            Global.HPE5 = Global.HPE5 - (Global.DamageP3 + (Global.DamageP3 * 300 / 100));
            PDamage.text = "";
            a3 -= 1;
            show3 = 0;
            dem_turn += 1;
    ...
    void delayCheckE5Die2()
    {
        if (Global.LevelP1 < 30)
        {
            Global.CurEXPP1 += Global.ExpE5;
        }
        if (Global.LevelP2 < 30 && P2Available == true)
        {
            Global.CurEXPP2 += Global.ExpE5;
        }
        if (Global.LevelP3 < 30 && P3Available == true)
        {
            Global.CurEXPP3 += Global.ExpE5;
        }
        Global.Zen += Global.ExpE5;
