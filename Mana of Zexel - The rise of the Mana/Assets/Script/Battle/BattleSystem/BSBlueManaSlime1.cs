...
public class BSBlueManaSlime1 : MonoBehaviour
{
    PlayerBattle pb;
    BlueManaSlimeBattle BMSB;
    ...
    void Update()
    {
        ...
        else if (aE9 > 0 && Global.HPE9 > 0 && GameOver == false && zoomDone == true)
        {
            CheckE9Die();
            ShowP1Panel(false);
            ShowP2Panel(false);
    ...
    public void UpdateUIText()
    {
        ...
        HPE9.text = "HP: " + Global.HPE9.ToString();
    ...
    void E9AttackTarget()
    {
        if (P3Available == false && P2Available == true)
            E9Hit = Random.Range(1, 3);
        else if (P3Available == true && P2Available == true)
            E9Hit = Random.Range(1, 4);
    ...
    void delayP1PressSkill()
    {
        ...
        {
            Global.CurMPP1 -= 20;
            Global.HPE9 = Global.HPE9 - (Global.DamageP1 + (Global.DamageP1 * 100 / 100));
            PDamage.text = "";
            a1 -= 1;
            show1 = 0;
            dem_turn += 1;
        ...
        else if (ChooseSkillIndex == 2)
        {
            ...
            Global.CurMPP1 -= 50;
            Global.HPE9 = Global.HPE9 - (Global.DamageP1 + (Global.DamageP1 * 200 / 100));
            PDamage.text = "";
            a1 -= 1;
            show1 = 0;
            dem_turn += 1;
        ...
        else if (ChooseSkillIndex == 3)
        {
            ...
            Global.CurMPP1 -= 100;
            Global.HPE9 = Global.HPE9 - (Global.DamageP1 + (Global.DamageP1 * 300 / 100));
            PDamage.text = "";
            a1 -= 1;
            show1 = 0;
            dem_turn += 1;
    ...
    void delayP2PressSkill()
    {
        ...
        {
            Global.CurMPP2 -= 20;
            Global.HPE9 = Global.HPE9 - (Global.DamageP2 + (Global.DamageP2 * 100 / 100));
            PDamage.text = "";
            a2 -= 1;
            show2 = 0;
            dem_turn += 1;
        ...
        {
            Global.CurMPP2 -= 50;
            Global.HPE9 = Global.HPE9 - (Global.DamageP2 + (Global.DamageP2 * 200 / 100));
            PDamage.text = "";
            a2 -= 1;
            show2 = 0;
            dem_turn += 1;
        ...
        {
            Global.CurMPP2 -= 100;
            Global.HPE9 = Global.HPE9 - (Global.DamageP2 + (Global.DamageP2 * 300 / 100));
            PDamage.text = "";
            a2 -= 1;
            show2 = 0;
            dem_turn += 1;
    ...
    void delayP3PressSkill()
    {
        ...
        else if (ChooseSkillIndex == 3)
        {
            ...
            Global.CurMPP3 -= 120;
            Global.HPE9 = Global.HPE9 - (Global.DamageP3 + (Global.DamageP3 * 300 / 100));
            PDamage.text = "";
            a3 -= 1;
            show3 = 0;
            dem_turn += 1;
